...
const range = 'Sheet1!G47:G86'; // Диапазон данных
  ...
  .then(data => {
    if (data.values && data.values.length > 0) {
      ...
      document.getElementById('a8').textContent = data.values[27]; 
       document.getElementById('a9').textContent = data.values[28]; 
      document.getElementById('a10').textContent = data.values[29]; 
      ...
      document.getElementById('d1').textContent = data.values[33]; 
      document.getElementById('d2').textContent = data.values[34]; 
      document.getElementById('d3').textContent = data.values[35]; 
      document.getElementById('d4').textContent = data.values[36]; 
      document.getElementById('d5').textContent = data.values[37];
      document.getElementById('d6').textContent = data.values[38];
      document.getElementById('d7').textContent = data.values[39];
    } else {
